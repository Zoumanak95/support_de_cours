...
/*-------------------------------------------------------------------------------------------
 * session_start permet de créer une session, ou de la réouvrir
 * cette déclaration doit se faire obligatoirement tout en haut du fichier, avant le DOCTYPE
 * sinon, cela génère un bug
 */
session_start();

/*------------------------------------------------------------------------------------------------------------------------------
 * session_unset est une autre fonction prédéfinie liée aux session_startelle permet de vider un fichier session d'une ou toutes les informations qui y sont contenues
 */
session_unset();

/*------------------------------------------------------------------------------------------------------------
 * session_destroy permet de détruire le fichier dans son ensemble, pas seulement informations qu'il contient
 */
session_destroy();
...
<!-- __________________________ Chapitre 15 : LES SESSIONS ______________________________ -->
<!-- cf. début de ce fichier -->
<?php
